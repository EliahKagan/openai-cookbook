...
- [How to fine-tune chat models](examples/How_to_finetune_chat_models.ipynb) [Aug 22, 2023]
...
- [PromptPerfect](https://promptperfect.jina.ai/): A paid product for testing and improving prompts.
